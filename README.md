...
>
> ** This project Started with a complex model that trys to solve multiple PH problems at a go, found here: [EVALUATION_NOTE.md](https://github.com/timothyOjodare/onehealth-record-v1/EVALUATION_NOTE.md). After my instructor's review I narrowed down to just one PH problem-solution that I named NotifiAZ (NotifiArizona) **
