...
>
> ** This project Started with a complex model that trys to solve multiple PH problems at a go, found here: [OneHealth Record README.md](https://github.com/timothyOjodare/onehealth-record-v1) and [EVALUATION_NOTE.md](https://github.com/TimothyOjodare/onehealth-record-v1/blob/main/EVALUATION_NOTE.md). After my instructor's review I narrowed down to just one PH problem-solution that I named NotifiAZ (NotifiArizona) **
